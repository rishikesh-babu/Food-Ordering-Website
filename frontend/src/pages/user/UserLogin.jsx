...
function UserLogin() {
    ...
    return (
        <div className="hero bg-base-200 dark:bg-gray-900 min-h-screen flex items-enter justify-center transition-colors duration-300">
            <div className="hero-content  flex-col lg:flex-row-reverse gap-3 sm:gap-12">
                {/* Hero Text */}
